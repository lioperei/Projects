...
/**Class TrainEngine is a subclass of Vehicle
...
public class TrainEngine extends Vehicle
{
    ...
    /**Constructor of TrainEngine.
     * @param x: X coordinate of this TrainEngine.
     * @param y: Y coordinate of this TrainEngine.
     */
    public TrainEngine(int x, int y){
    	super(x, y, (int) (LENGTH_FACTOR * UNIT), (int) (HEIGHT_FACTOR * UNIT));
    }
	...
	// Set color for depending on if this TrainEngine is selected. 
	if (super.getSelected()) g2.setColor(Color.RED);
	...
	g2.fill(wheel6) ;
	/// draw trailer
	if (super.hasTrailer())	this.trailer.draw(g2);
    }
}
